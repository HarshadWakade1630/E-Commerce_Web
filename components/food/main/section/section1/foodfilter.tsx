export default function FoodFilter() {
  ...
  return (
    <div className="food-filter mx-auto flex w-full max-w-[1920px] items-center gap-2 overflow-x-auto whitespace-nowrap rounded-t-2xl border-b border-black/5 bg-white/95 px-3 py-2.5 shadow-sm backdrop-blur-md scrollbar-none [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] sm:gap-3.5 sm:px-8 sm:py-3.5 md:px-10">
      <button
