...
export default function SubsectionFilter({
 ...
 return (
  <div className="mb-3 flex w-full items-center gap-2 overflow-x-auto whitespace-nowrap rounded-t-2xl border-b border-black/5 bg-white/95 px-3 py-3 shadow-sm backdrop-blur-md scrollbar-none sm:gap-3 sm:px-6 lg:px-8">
